...
function websdkready() {
  ...
  // var SDK_KEY = "_KqJ2LhdS72IEtQxkgIePg";
  var SDK_KEY = "A2t1duQvN7UY8PpKrVvjiVHdqddFsOkEW0Ty";
  /**
   ...
   */
  // var SDK_SECRET = "is6KgZKTYTZDw1Cs1R4RQyYWrkIKNoLH7lPm";
  var SDK_SECRET = "JgyYmmZ2IVHSL5FgTMgjSTrxzblyPdpIYaCp";

  // some help code, remember mn, pwd, lang to cookie, and autofill.
  document.getElementById("display_name").value =
    sessionStorage.getItem("meetingHostName");
  document.getElementById("meeting_number").value =
    sessionStorage.getItem("meetingId");
  document.getElementById("meeting_pwd").value =
    sessionStorage.getItem("meetingPassword");
  // document.getElementById("display_name").value =
  //   "CDN" +
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          if (location.hostname === "meritbodhi.com") {
            var joinUrl =
              "/admin/course-edit/Zoom/meeting.html?" +
              testTool.serialize(meetingConfig);
            window.open(joinUrl, "_self");
          } else {
            var joinUrl =
              "/course-edit/Zoom/meeting.html?" +
              testTool.serialize(meetingConfig);
            window.open(joinUrl, "_self");
          }
        },
